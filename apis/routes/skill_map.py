...
async def create_skill_map(req: SkillMapRequest):
    ...
    try:
        ...
        result["warning"] = f"AI生成失败({str(e)[:50]})，使用预置数据"
    ...
    return {
        ...
        "skill_tree": {
            "核心能力": [
                ...
                {"name": "CSS3布局与动画", "level": "基础", "description": "Flexbox/Grid布局，CSS动画与过渡"},
                {"name": "JavaScript核心", "level": "核心", "description": "ES6+语法、DOM操作、异步编程"},
                {"name": "前端框架应用", "level": "进阶", "description": "Vue3/React等主流框架"},
                {"name": "工程化工具", "level": "进阶", "description": "Webpack/Vite构建工具"},
                {"name": "网络通信", "level": "核心", "description": "HTTP协议、RESTful API、跨域处理"},
                {"name": "性能优化", "level": "高级", "description": "加载优化、渲染优化、监控"},
                {"name": "安全防护", "level": "进阶", "description": "XSS/CSRF防御、CSP策略"},
            ],
            "专业技能": [
                {"name": "组件化开发", "tools": ["Vue3", "React"], "proficiency": "熟练掌握"},
                {"name": "状态管理", "tools": ["Pinia", "Redux"], "proficiency": "熟练掌握"},
                {"name": "前端路由", "tools": ["Vue Router", "React Router"], "proficiency": "熟练掌握"},
                {"name": "响应式设计", "tools": ["媒体查询", "Tailwind CSS"], "proficiency": "掌握"},
                {"name": "数据可视化", "tools": ["ECharts", "D3.js"], "proficiency": "了解"},
                {"name": "移动端开发", "tools": ["Uni-app", "微信小程序"], "proficiency": "掌握"},
            ],
            "工具技能": [
                ...
                {"name": "Postman", "category": "测试工具", "importance": "推荐"},
                {"name": "Figma", "category": "设计工具", "importance": "推荐"},
                {"name": "Docker", "category": "部署工具", "importance": "推荐"},
            ],
            "软技能": [
                {"name": "沟通协作", "scenario": "团队协作、需求对接"},
                {"name": "问题分析", "scenario": "Bug定位、性能排查"},
                {"name": "持续学习", "scenario": "技术迭代跟进"},
                {"name": "代码审查", "scenario": "Pull Request审查"},
                {"name": "文档撰写", "scenario": "技术文档、README"},
            ],
        },
        "career_path": [
            {"stage": "入门期", "duration": "0-3个月", "milestones": ["掌握HTML/CSS/JS基础", "能独立完成静态页面"]},
            {"stage": "初级前端", "duration": "3-12个月", "milestones": ["掌握一个前端框架", "能完成完整项目", "理解组件化开发"]},
            {"stage": "中级前端", "duration": "1-3年", "milestones": ["掌握工程化工具", "性能优化实践", "主导项目开发"]},
            {"stage": "高级前端", "duration": "3年+", "milestones": ["架构设计能力", "跨端开发经验", "技术选型决策"]},
        ],
        "related_jobs": ["全栈开发工程师", "前端架构师", "Web性能工程师", "小程序开发工程师"],
    }
